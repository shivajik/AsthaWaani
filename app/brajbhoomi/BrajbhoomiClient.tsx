...
const sacredPlaces = [
  { slug: 'vrindavan', name: 'Vrindavan', nameHi: 'वृंदावन', description: 'The Land of Divine Love and Bhakti', descriptionHi: 'दिव्य प्रेम और भक्ति की भूमि', image: '/attached_assets/Temple/Prem_mandir.png' },
  ...
  { slug: 'govardhan', name: 'Govardhan', nameHi: 'गोवर्धन', description: 'The Sacred Hill of Protection', descriptionHi: 'रक्षा का पवित्र पर्वत', image: '/attached_assets/Temple/Daan_Ghati.png' },
  { slug: 'mahavan', name: 'Mahavan', nameHi: 'महावन', description: 'The Forest of Divine Protection', descriptionHi: 'दिव्य संरक्षण का वन', image: '/attached_assets/Temple/mahaban_Chaurasi.png' },
  { slug: 'barsana', name: 'Barsana', nameHi: 'बरसाना', description: 'The Divine Land of Radha Rani', descriptionHi: 'राधा रानी की दिव्य भूमि', image: '/attached_assets/Temple/Barsana_Radha_Rani.png' },
];
