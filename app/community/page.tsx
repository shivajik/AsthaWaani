    ...
    <main className="min-h-screen pt-24 pb-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-[hsl(225,55%,35%)] mb-4">Join Our Community</h1>
        ...
        <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {socialLinks.map((social) => (
            <a
              ...
              className={`flex items-start gap-4 p-6 rounded-xl border-2 transition-all ${social.color}`}
            >
              <div className={`flex-shrink-0 ${social.iconColor}`}>
                {social.icon}
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-lg text-gray-900 mb-1">{social.name}</h3>
                <p className="text-gray-600 text-sm">{social.description}</p>
              </div>
              <svg className="w-5 h-5 text-gray-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
