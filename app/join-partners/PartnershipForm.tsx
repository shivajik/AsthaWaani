...
export function PartnershipForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-sm border p-8 md:p-10">
      <h2 className="text-2xl font-serif font-bold text-[hsl(225,55%,35%)] mb-2">Partnership Form</h2>
      <p className="text-gray-500 mb-8">Please fill in the details below and we will get back to you.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          <label htmlFor="details" className="block text-sm font-medium text-gray-700 mb-1">Partnership Details</label>
          <textarea
            id="details"
            required
            rows={5}
